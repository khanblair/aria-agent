...
- **Backend/Data Layer:** Convex – schema‑driven storage, caching, incremental‑learning tracking  
...
| **LEARN**        | Incrementally fetch & store 10‑15 API docs per language (e.g. Python built‑ins, JS Array methods). |
